...
bb9:
  %r157 = getelementptr [10 x i32 ], [10 x i32 ]* %r116, i32 0, i32 %r291
  %r158 = load i32, i32* %r157
  %r160 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r290
...
bb12:
  %r165 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r292
  %r167 = getelementptr [10 x i32 ], [10 x i32 ]* %r116, i32 0, i32 %r291
...
bb13:
  %r174 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r292
  %r176 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r290
...
bb16:
  %r186 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r294
  %r188 = getelementptr [10 x i32 ], [10 x i32 ]* %r116, i32 0, i32 %r293
...
bb19:
  %r198 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r296
  %r200 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r295
