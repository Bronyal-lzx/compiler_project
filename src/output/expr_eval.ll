...
bb31:
  %r303 = add i32 0, 0
  %r304 = add i32 %r148, 0
  %r150 = getelementptr [256 x i32], ptr %r147, i32 0, i32 0
  %r151 = getelementptr [256 x i32], ptr %r147, i32 0, i32 0
  %r152 = load i32, ptr %r151, align 4
  %r153 = add i32 %r152, 1
  store i32 %r153, ptr %r150, align 4
  %r305 = add i32 0, 0
  %r155 = getelementptr [256 x i32], ptr %r147, i32 0, i32 0
  %r156 = load i32, ptr %r155, align 4
  %r306 = add i32 %r156, 0
  %r158 = getelementptr [256 x i32], ptr %r147, i32 0, i32 %r306
  store i32 %r304, ptr %r158, align 4
  ret void
}
...
bb32:
  %r309 = add i32 0, 0
  %r162 = getelementptr [256 x i32], ptr %r160, i32 0, i32 0
  %r163 = load i32, ptr %r162, align 4
  %r310 = add i32 %r163, 0
  %r311 = add i32 0, 0
  %r166 = getelementptr [256 x i32], ptr %r160, i32 0, i32 %r310
  %r167 = load i32, ptr %r166, align 4
  %r312 = add i32 %r167, 0
  %r168 = getelementptr [256 x i32], ptr %r160, i32 0, i32 0
  %r169 = getelementptr [256 x i32], ptr %r160, i32 0, i32 0
...
bb33:
  %r314 = add i32 0, 0
  %r175 = getelementptr [256 x i32], ptr %r173, i32 0, i32 0
  %r176 = load i32, ptr %r175, align 4
  %r315 = add i32 %r176, 0
  %r178 = getelementptr [256 x i32], ptr %r173, i32 0, i32 %r315
...
bb34:
  %r181 = getelementptr [256 x i32], ptr %r180, i32 0, i32 0
...
bb60:                                             ; preds = %bb61, %bb58
  call void @stack_push(ptr %r226, i32 %r352)
