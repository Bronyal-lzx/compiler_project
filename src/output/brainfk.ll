...
bb3:                                              ; preds = %bb2
  %r107 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r187
  %r108 = call i32 @getch()
...
bb4:                                              ; preds = %bb2
  %r112 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r187
...
bb6:                                              ; preds = %bb22, %bb5
  ...
  %r118 = getelementptr [65536 x i32], ptr %r113, i32 0, i32 %r196
  %r119 = load i32, ptr %r118, align 4
  %r120 = icmp ne i32 %r119, 0
  br i1 %r120, label %bb7, label %bb8

bb7:                                              ; preds = %bb6
  %r122 = getelementptr [65536 x i32], ptr %r113, i32 0, i32 %r196
...
bb25:                                             ; preds = %bb24
  %r167 = sub i32 %r201, 1
  %r203 = add i32 %r167, 0
  %r169 = getelementptr [65536 x i32], ptr %r113, i32 0, i32 %r203
