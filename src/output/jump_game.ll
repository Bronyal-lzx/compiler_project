...
bb7:                                              ; preds = %bb6
  %r117 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r189
...
bb8:                                              ; preds = %bb6
  %r122 = sub i32 %r187, 1
  %r190 = add i32 %r122, 0
  %r124 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r190
...
bb10:                                             ; preds = %bb9
  %r132 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r192
...
bb12:                                             ; preds = %bb10
  %r140 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r192
...
bb16:                                             ; preds = %bb15
  ...
  %r196 = add i32 %r151, 0
  %r153 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r196
  %r154 = load i32, ptr %r153, align 4
  %r155 = icmp ne i32 %r154, 0
  br i1 %r155, label %bb18, label %bb19

bb18:                                             ; preds = %bb16
  %r157 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r192
...
bb20:
  ...
  %r203 = add i32 10, 0
  %r177 = call i32 @canJump(ptr %r165, i32 %r203)
  %r204 = add i32 %r177, 0
