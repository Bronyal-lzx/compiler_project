...
bb6:                                              ; preds = %bb5
  ...
  %r121 = sub i32 %r120, 1
  %r214 = add i32 %r121, 0
  %r123 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r214
...
bb9:                                              ; preds = %bb8
  ...
  %r212 = add i32 %r133, 0
  %r135 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r212
  store i32 1, ptr %r135, align 4
  %r137 = add i32 %r202, 1
  %r213 = add i32 %r137, 0
  br label %bb8
...
bb15:                                             ; preds = %bb14
  ...
  %r161 = add i32 %r160, 1
  %r210 = add i32 %r161, 0
  %r163 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r208
  %r165 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r209
  %r166 = load i32, ptr %r165, align 4
  %r168 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r210
  %r169 = load i32, ptr %r168, align 4
  %r170 = add i32 %r166, %r169
  store i32 %r170, ptr %r163, align 4
  %r172 = sub i32 %r206, 1
  %r211 = add i32 %r172, 0
  br label %bb14
...
bb13:                                             ; preds = %bb11
  %r175 = getelementptr [9 x i32], ptr %r108, i32 0, i32 0
