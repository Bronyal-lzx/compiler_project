...
define i32 @insert(ptr %r100, i32 %r101) {
bb1:
  %r162 = add i32 0, 0
  %r163 = add i32 0, 0
  %r164 = add i32 %r101, 0
...
bb7:                                              ; preds = %bb6
  %r121 = sub i32 %r170, 1
  %r171 = add i32 %r121, 0
  %r123 = getelementptr [11 x i32], ptr %r100, i32 0, i32 %r170
  %r125 = getelementptr [11 x i32], ptr %r100, i32 0, i32 %r171
  %r126 = load i32, ptr %r125, align 4
  store i32 %r126, ptr %r123, align 4
  %r128 = getelementptr [11 x i32], ptr %r100, i32 0, i32 %r168
  store i32 %r164, ptr %r128, align 4
  %r131 = sub i32 %r170, 1
  %r172 = add i32 %r131, 0
  br label %bb6
...
bb9:
  ...
  %r132 = alloca [11 x i32], align 4
  %r133 = getelementptr [11 x i32], ptr %r132, i32 0, i32 0
  store i32 1, ptr %r133, align 4
  %r134 = getelementptr [11 x i32], ptr %r132, i32 0, i32 1
  store i32 3, ptr %r134, align 4
  %r135 = getelementptr [11 x i32], ptr %r132, i32 0, i32 2
  store i32 4, ptr %r135, align 4
  %r136 = getelementptr [11 x i32], ptr %r132, i32 0, i32 3
  store i32 7, ptr %r136, align 4
  %r137 = getelementptr [11 x i32], ptr %r132, i32 0, i32 4
  store i32 8, ptr %r137, align 4
  %r138 = getelementptr [11 x i32], ptr %r132, i32 0, i32 5
  store i32 11, ptr %r138, align 4
  %r139 = getelementptr [11 x i32], ptr %r132, i32 0, i32 6
  store i32 13, ptr %r139, align 4
  %r140 = getelementptr [11 x i32], ptr %r132, i32 0, i32 7
  store i32 18, ptr %r140, align 4
  %r141 = getelementptr [11 x i32], ptr %r132, i32 0, i32 8
  store i32 56, ptr %r141, align 4
  %r142 = getelementptr [11 x i32], ptr %r132, i32 0, i32 9
  store i32 78, ptr %r142, align 4
  %r176 = add i32 0, 0
  %r177 = add i32 0, 0
  %r178 = add i32 0, 0
  %r145 = call i32 @getint()
  %r179 = add i32 %r145, 0
  %r147 = call i32 @insert(ptr %r132, i32 %r179)
  %r180 = add i32 %r147, 0
  br label %bb10

bb10:                                             ; preds = %bb11, %bb9
  %r181 = phi i32 [ %r178, %bb9 ], [ %r184, %bb11 ]
  %r149 = load i32, ptr @N, align 4
  %r150 = icmp slt i32 %r181, %r149
  br i1 %r150, label %bb11, label %bb12

bb11:                                             ; preds = %bb10
  %r152 = getelementptr [11 x i32], ptr %r132, i32 0, i32 %r181
