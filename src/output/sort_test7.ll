...
bb3:                                              ; preds = %bb2
  ...
  %r310 = add i32 %r126, 0
  %r128 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r285
  %r130 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r310
...
bb6:                                              ; preds = %bb5
  ...
  %r140 = add i32 %r139, 1
  %r308 = add i32 %r140, 0
  %r142 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r286
  %r144 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r308
...
bb8:                                              ; preds = %bb14, %bb7
  %r290 = phi i32 [ %r288, %bb7 ], [ %r301, %bb14 ]
  %r291 = phi i32 [ %r287, %bb7 ], [ %r302, %bb14 ]
  %r292 = phi i32 [ %r289, %bb7 ], [ %r303, %bb14 ]
  %r152 = icmp ne i32 %r291, %r277
  br i1 %r152, label %bb11, label %bb10

bb11:                                             ; preds = %bb8
  %r155 = icmp ne i32 %r290, %r279
  br i1 %r155, label %bb9, label %bb10

bb9:                                              ; preds = %bb11
  %r157 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r291
  %r158 = load i32, ptr %r157, align 4
  %r160 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r290
...
bb12:                                             ; preds = %bb9
  %r165 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r292
  %r167 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r291
...
bb13:                                             ; preds = %bb9
  %r174 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r292
  %r176 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r290
...
bb14:                                             ; preds = %bb13, %bb12
  %r301 = phi i32 [ %r290, %bb12 ], [ %r305, %bb13 ]
  %r302 = phi i32 [ %r307, %bb12 ], [ %r291, %bb13 ]
  %r303 = phi i32 [ %r306, %bb12 ], [ %r304, %bb13 ]
  br label %bb8
...
bb15:                                             ; preds = %bb16, %bb10
  %r293 = phi i32 [ %r291, %bb10 ], [ %r300, %bb16 ]
  %r294 = phi i32 [ %r292, %bb10 ], [ %r299, %bb16 ]
  %r184 = icmp slt i32 %r293, %r277
  br i1 %r184, label %bb16, label %bb17

bb16:                                             ; preds = %bb15
  %r186 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r294
  %r188 = getelementptr [10 x i32], ptr %r116, i32 0, i32 %r293
...
bb18:                                             ; preds = %bb19, %bb17
  %r295 = phi i32 [ %r290, %bb17 ], [ %r298, %bb19 ]
  %r296 = phi i32 [ %r294, %bb17 ], [ %r297, %bb19 ]
  %r196 = icmp slt i32 %r295, %r279
  br i1 %r196, label %bb19, label %bb20

bb19:                                             ; preds = %bb18
  %r198 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r296
  %r200 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r295
...
bb22:                                             ; preds = %bb21
  ...
  %r322 = add i32 %r218, 0
  %r222 = call i32 @MergeSort(ptr %r206, i32 %r319, i32 %r322)
  %r323 = add i32 %r222, 0
  %r224 = add i32 %r322, 1
  %r324 = add i32 %r224, 0
  %r227 = call i32 @MergeSort(ptr %r206, i32 %r324, i32 %r321)
  %r325 = add i32 %r227, 0
  %r231 = call i32 @Merge(ptr %r206, i32 %r319, i32 %r322, i32 %r321)
  %r326 = add i32 %r231, 0
  br label %bb23
...
bb24:
  ...
  %r246 = sub i32 %r245, 1
  %r332 = add i32 %r246, 0
  %r249 = call i32 @MergeSort(ptr %r232, i32 %r330, i32 %r332)
  %r333 = add i32 %r249, 0
  br label %bb25
...
bb26:                                             ; preds = %bb25
  %r254 = getelementptr [10 x i32], ptr %r232, i32 0, i32 %r334
