...
bb4:                                              ; preds = %bb3
  %r121 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r156
  %r123 = call i32 @mod(i32 %r155, i32 10)
  store i32 %r123, ptr %r121, align 4
...
bb6:
  ...
  %r164 = add i32 1478, 0
  %r132 = call i32 @split(i32 %r164, ptr %r130)
  %r165 = add i32 %r132, 0
  %r166 = add i32 0, 0
  %r167 = add i32 0, 0
  br label %bb7
...
bb8:                                              ; preds = %bb7
  %r137 = getelementptr [4 x i32], ptr %r130, i32 0, i32 %r168
  %r138 = load i32, ptr %r137, align 4
  %r169 = add i32 %r138, 0
  call void @putint(i32 %r169)
  %r140 = load i32, ptr @newline, align 4
