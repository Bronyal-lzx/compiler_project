...
bb4:                                              ; preds = %bb3
  %r119 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r161
  %r121 = call i32 @mod(i32 %r160, i32 10)
  store i32 %r121, ptr %r119, align 4
...
bb5:                                              ; preds = %bb3
  %r126 = getelementptr [4 x i32], ptr %r113, i32 0, i32 0
  %r127 = load i32, ptr %r126, align 4
  %r128 = getelementptr [4 x i32], ptr %r113, i32 0, i32 3
  %r129 = load i32, ptr %r128, align 4
  %r130 = icmp eq i32 %r127, %r129
  br i1 %r130, label %bb9, label %bb7

bb9:                                              ; preds = %bb5
  %r131 = getelementptr [4 x i32], ptr %r113, i32 0, i32 1
  %r132 = load i32, ptr %r131, align 4
  %r133 = getelementptr [4 x i32], ptr %r113, i32 0, i32 2
