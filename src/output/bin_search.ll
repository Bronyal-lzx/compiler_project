...
bb3:                                              ; preds = %bb2
  %r106 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r168
  %r108 = add i32 %r168, 1
  store i32 %r108, ptr %r106, align 4
  %r110 = add i32 %r168, 1
  %r184 = add i32 %r110, 0
  br label %bb2
...
bb5:                                              ; preds = %bb11, %bb4
  ...
  %r124 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r175
...
bb6:                                              ; preds = %bb8
  ...
  %r179 = add i32 %r134, 0
  %r137 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r179
...
bb7:                                              ; preds = %bb8, %bb5
  %r146 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r175
